<x-layout>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-8 shadow rounded-3 p-4 main-color">
                ...
                <div class="row">
                        ...
                        <form action="{{ route('train.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('next_trip') is-invalid @enderror"
                                    id="next_trip" name="next_trip" value="{{ old('next_trip') }}">
                                @error('next_trip')
                                    <p class="text-danger"> {{ $message }} </p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('speed') is-invalid @enderror"
                                    id="speed" name="speed" value="{{ old('speed') }}">
                                @error('speed')
                                    <p class="text-danger"> {{ $message }} </p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('users') is-invalid @enderror"
                                    id="users" name="users" value="{{ old('users') }}">
                                @error('users')
                                    <p class="text-danger"> {{ $message }} </p>
                                @enderror
                            </div>
                    ...
                    <div
                        class="d-none d-md-inline-block col-md-6 d-flex mt-5 justify-content-center align-items-center">
